using ESTest.Api.Models;
using ESTest.Api.Providers;
using ESTest.Api.Results;
using ESTest.Domain;
...
namespace ESTest.Api.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            IdentityUser user = await UserManager.FindByIdAsync(User.Identity.GetUserId<long>());
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            SystemUser user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
